...
//kpxy
if (!isset($current_task) || ($current_task == 2)) {
	echo '[[[kpxy]]]' . PHP_EOL;
	$resource_kpxy = file_get_contents($cfg_resource['kpxy']);
	if ($resource_kpxy === FALSE) {
		exit;
	}
	$xy = array();
